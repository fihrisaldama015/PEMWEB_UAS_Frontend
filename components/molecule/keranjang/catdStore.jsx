    ...
    <div>
      <div className=" ">
        <div className=" w-full  px-5 py-3 shadow-md rounded-md flex relative">
          <button
            onClick={handleDeleteStoreCart}
            className=" absolute top-2 right-2 opacity-20 p-2 rounded-full hover:bg-gray-500 "
          >
            <svg
              fill="#000000"
          ...
          <div className="ml-10 flex flex-col ">
            ...
            <div className=" flex gap-2">
              <Link
                href={`/cart/${_id_toko}`}
                className=" bg-[#FFD600] py-2 px-5 rounded-lg"
              >
                <p className=" font-bold text-xs">Detail</p>
              </Link>
              <div
                onClick={handleBuy}
                className=" bg-[#FB7777] py-2 px-5 rounded-lg cursor-pointer"
              >
