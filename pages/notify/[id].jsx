...
export default function DailyNotify() {
  ...
  const Status = (status) => {
    switch (status) {
      case 0:
        return (
          <div className=" w-full border border-[#CFA948] text-[#CFA948] py-2 px-1 text-center rounded-lg font-bold">
            Sedang menunggu Pesanan disetujui ...{" "}
          </div>
        );
      case 1:
        return (
          <div className=" w-full border border-[#618D80] text-[#618D80]  py-2 px-1 text-center rounded-lg font-bold">
      ...
      case 2:
        return (
          <Link href={`/rating/${transactionDetail?.code?.transaction_id}`}>
            <div className=" w-full bg-[#618D80] text-white py-2 px-1 text-center rounded-lg font-bold">
              Beri rating
            </div>
            ;
          </Link>
      ...
      case 3:
        return (
          <button
            ...
            className=" w-full border border-[#FB7777] text-[#FB7777] py-2 px-1 text-center rounded-lg font-bold"
          >
            ...
            <div className="px-8 py-9">
              ...
              <div className=" rounded-lg shadow-lg px-3 py-11">
                ...
                <div>
                  <div className="flex w-full p-4 gap-6  ">
                    ...
                    <div className="py-6">
                      ...
                      {/*  */}
                      <div className=" text-[#618D80] font-bold">
                        {" "}
                        Rp. {totalPrice}{" "}
                      </div>
                    </div>
                ...
                <div className=" flex flex-col items-center gap-1">
                  ...
                  <div className="text-[#618D80] font-bold text-4xl tracking-widest">
                    {transactionDetail?.code?.code}
                  </div>
                </div>
                {/*  */}
                <div className=" mt-6">
